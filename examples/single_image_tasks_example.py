"""Single-image task example for the public DGE interface."""
...
REQUESTS = [
    {
        "name": "single_image_summary",
        "mode": "summary",
        "input": {
            "summary_type": "single_image",
            "scene_id": SCENE_ID,
            "metadata_dir": METADATA_ROOT,
            "image_path": color_image(240),
            "min_visibility": 0.1,
        },
    },
    {
        "name": "single_image_relative_direction_valid",
        "mode": "validate",
        "input": {
            "task_type": "single_image_relative_direction",
            "scene_id": SCENE_ID,
            "metadata_dir": METADATA_ROOT,
            "image_path": color_image(1200),
            "question": "What is the position of the window with respect to the toilet in this image?",
        },
    },
    {
        "name": "distance_cam_obj_valid",
        "mode": "validate",
        "input": {
            "task_type": "distance cam obj",
            "scene_id": SCENE_ID,
            "metadata_dir": METADATA_ROOT,
            "image_path": color_image(1200),
    ...
    {
        "name": "depth_order_obj_obj_valid",
        "mode": "validate",
        "input": {
            "task_type": "depth_order Obj_obj",
            "scene_id": SCENE_ID,
            "metadata_dir": METADATA_ROOT,
            "image_path": color_image(240),
            "question": "Which object is closer to the camera, the night stand or the table?",
        },
    },
    {
        "name": "single_image_relative_direction_invalid_same_object",
        "mode": "validate",
        "input": {
            "task_type": "single_image_relative_direction",
            "scene_id": SCENE_ID,
            "metadata_dir": METADATA_ROOT,
            "image_path": color_image(240),
            "question": "In this image, where is the table relative to the table?",
        },
    },
    {
        "name": "distance_cam_obj_invalid_missing_label",
        "mode": "validate",
        "input": {
            ...
            "metadata_dir": METADATA_ROOT,
            "image_path": color_image(1200),
            "question": "What is the nearest distance from the camera to the galaxy?",
        },
    },
    {
        "name": "depth_order_obj_obj_invalid_same_object",
        "mode": "validate",
        "input": {
            ...
            "metadata_dir": METADATA_ROOT,
            "image_path": color_image(240),
            "question": "Which object is closer to the camera, the table or the table?",
        },
    },
]
