...
class AlgorithmConfig:
    ...
    two_round_training: bool = False
    """enable two-round training (n² architecture): round1 generates questions, round2 generates answers"""
@dataclass
class TrainerConfig:
    total_epochs: int = 15
    ...
    world_simulator_max_workers: int = 4
    """max worker threads for Round1 world-simulator validation"""
    critic_warmup: int = 0
    """critic warmup steps"""
    val_freq: int = -1
